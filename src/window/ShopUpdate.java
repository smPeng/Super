...
public class ShopUpdate extends JFrame {
	...
	private ShopUpdate() {
		...
		lblNewLabel_1.setBounds(186, 10, 54, 15);
		...
		lblNewLabel_3.setBounds(186, 41, 54, 15);
		...
		lblNewLabel_5.setBounds(186, 66, 54, 15);
		...
		txtName.setBounds(229, 7, 129, 21);
		contentPane.add(txtName);
		txtName.setColumns(10);
		
		txtSllPrc = new JTextField();
		txtSllPrc.setBounds(229, 35, 66, 21);
		...
		cboCategory.setBounds(229, 63, 129, 21);
		...
		btnUpdate.setBounds(239, 87, 93, 23);
		...
		scrollPane.setBounds(11, 125, 410, 182);
